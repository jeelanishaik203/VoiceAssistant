...
chromePath = "C:/Users/AS185825/AppData/Local/Google/Chrome/Application/chrome.exe %s"
...
def idle_exit_helper():
    speak(f"Hey {creator}, Seems like you are away. {assistant} signing off. Bye!")
    print(f"Hey {creator}, Seems like you are away. {assistant} signing off. Bye!")
    exit()
...
if __name__ == "__main__":
    ...
    while idle_count < max_idle_count:
        ...
        if user_voice_command == "none":
            ...
            repeat_mode()
        elif 'i love you' in user_voice_command:
            speak("I am really sorry to say this. Right now i am dating with Siri.")
